...
void main() async {
  ...
  dioAdapter.onGet(
    'https://play.dhis2.org/2.35.11/api/organisationUnits.json?filter=path:ilike:ImspTQPwCqd&fields=id,dirty,lastUpdated,created,name,displayName,shortName,code,translations,level,path,externalAccess,openingDate,geometry,parent&paging=false',
