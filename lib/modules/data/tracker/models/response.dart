class LatestVersionResponse {
    ...
    factory LatestVersionResponse.fromJson(Map<String, dynamic> json){ 
        return LatestVersionResponse(
            status: json["status"],
            validationReport: json["validationReport"] == null ? null : ValidationReport.fromJson(json["validationReport"]),
            stats: json["stats"] == null ? null : Stats.fromJson(json["stats"]),
            bundleReport: json["bundleReport"] == null ? null : BundleReport.fromJson(json["bundleReport"]),
        );
    }
...
class BundleReport {
    ...
    factory BundleReport.fromJson(Map<String, dynamic> json){ 
        return BundleReport(
            status: json["status"],
            typeReportMap: json["typeReportMap"] == null ? null : TypeReportMap.fromJson(json["typeReportMap"]),
            stats: json["stats"] == null ? null : Stats.fromJson(json["stats"]),
        );
    }
...
class TypeReportMap {
    ...
    factory TypeReportMap.fromJson(Map<String, dynamic> json){ 
        return TypeReportMap(
            relationship: json["RELATIONSHIP"] == null ? null : Enrollment.fromJson(json["RELATIONSHIP"]),
            trackedEntity: json["TRACKED_ENTITY"] == null ? null : Enrollment.fromJson(json["TRACKED_ENTITY"]),
...
class Enrollment {
    ...
    factory Enrollment.fromJson(Map<String, dynamic> json){ 
        return Enrollment(
            ...
            stats: json["stats"] == null ? null : Stats.fromJson(json["stats"]),
            objectReports: json["objectReports"] == null ? [] : List<ObjectReport>.from(json["objectReports"]!.map((x) => ObjectReport.fromJson(x))),
        );
    }
...
class ObjectReport {
    ...
    factory ObjectReport.fromJson(Map<String, dynamic> json){ 
        return ObjectReport(
            ...
            uid: json["uid"],
            index: json["index"],
            errorReports: json["errorReports"] == null ? [] : List<dynamic>.from(json["errorReports"]!.map((x) => x)),
        );
    }
...
class ValidationReport {
    ...
    factory ValidationReport.fromJson(Map<String, dynamic> json){ 
        return ValidationReport(
            errorReports: json["errorReports"] == null ? [] : List<dynamic>.from(json["errorReports"]!.map((x) => x)),
            warningReports: json["warningReports"] == null ? [] : List<dynamic>.from(json["warningReports"]!.map((x) => x)),
        );
    }
